...
function ZN:Config()
  ...
  ConfigFrame.DebugMode = ZN:createCheckBox(ConfigFrame, "TOPLEFT", ConfigFrame, "TOPLEFT", 20, -20, "Debug Mode", 14, ZN.Colors.ACTIVE, 200, ZNotes.DebugMode) 
  ConfigFrame.DebugMode:SetScript("OnClick",function(self)
    self.toggleChecked()
    ZNotes.DebugMode = self.active
    ZN:DebugModeToggle()
  end)

  ConfigFrame.DebugMode.button:SetScript("OnMouseDown",function()
    ConfigFrame.DebugMode.toggleChecked()
    ZNotes.DebugMode = ConfigFrame.DebugMode
    ZN:DebugModeToggle()
  end)
  ZNDebugMode = {}
  ...
  if not ConfigFrame.DebugMode.active then
