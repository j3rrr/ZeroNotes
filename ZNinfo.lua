...
ZNInfoFrame.GICredits = ZN.CreateGenericButton("ZNGICredits", ZNInfoFrame, "BOTTOM", ZNInfoFrame, "BOTTOM", 300, 30, 0, 0,0,0, 8, ZN.Colors.INACTIVE, ZN.Colors.ROWBG, nil, "'Kraken' & 'Monk' Icons by www.game-icons.net", "CENTER",false )
